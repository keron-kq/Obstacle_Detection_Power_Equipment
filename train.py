...
import os
os.environ["KMP_DUPLICATE_LIB_OK"]="TRUE" #防止多线程冲突
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/training/detection.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/detection.yaml', help='data.yaml path')
